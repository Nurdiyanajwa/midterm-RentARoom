...
if (isset($_POST["submit"])){
    ...
    $sqlregister = "INSERT INTO tbh_room (`contact`, `title`, `description`, `price`, `deposit`, `state`, `area`,`latitude`, `longitude`) 
...
<body>
    ...
    <div class="w3-khaki w3-center w3-border-top w3-border-bottom">
    ...
    <form class="w3-container w3-padding" name="registerForm" action="newroom.php" method="POST" enctype="multipart/form-data" onsubmit="return confirmDialog()">
       <p> 
        ...
        <i class = "fa fa-phone icon"></i>
            <label>Contact</label>
            <input class="w3-input w3-border w3-round w3-light-grey" name="contact" id="idcontact" type="text" required>
        </p>
        <p>
        <i class = "fa fa-edit icon"></i>
            <label>Title</label>
            <input class="w3-input w3-border w3-round w3-light-grey" name="title" id="idtitle" type="text" required>
        </p>
        <p>
        ...
        <i class = "fa fa-money icon"></i>
            <label>Deposit</label>
            <input class="w3-input w3-border w3-round w3-light-grey" name="deposit" id="iddeposit" type="text" required>
        </p>
        <i class = "fa fa-home icon"></i>
            <label>State</label>
            <input class="w3-input w3-border w3-round w3-light-grey" name="state" id="idstate" type="text" required>
        </p>
        <p>
        <i class = "fa fa-map-pin icon"></i>
            <label>Area</label>
            <input class="w3-input w3-border w3-round w3-light-grey" name="area" id="idarea" type="text" required>
        </p>
        <p>
        <i class = "fa fa-location-arrow icon"></i>
            <label>Latitude</label>
            <input class="w3-input w3-border w3-round w3-light-grey" name="latitude" id="idlatitude" type="text" required>
        </p>
        <p>
        <i class = "fa fa-map-marker icon"></i>
            <label>Longitude</label>
            <input class="w3-input w3-border w3-round w3-light-grey" name="longitude" id="idlongitude" type="text" required>
        </p>

        <div class="row">
            <input class="w3-input w3-border w3-block  w3-round w3-khaki" type="submit" name="submit" value="Submit">
        </div>    
    </form>
        </div>
    </div>
